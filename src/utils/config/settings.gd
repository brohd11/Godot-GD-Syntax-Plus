...
const INHERITED_MEMBER_ENABLE = &"plugin/syntax_plus/member/inherited_member_enable"
const INHERITED_MEMBER_COLOR = &"plugin/syntax_plus/member/inherited_member_color"
const BASE_TYPE_MEMBER_ENABLE = &"plugin/syntax_plus/member/base_type_member_enable"
const BASE_TYPE_MEMBER_COLOR = &"plugin/syntax_plus/member/base_type_member_color"
const INNER_CLASS_MEMBER_ENABLE = &"plugin/syntax_plus/member/inner_class_member_enable"
const INNER_CLASS_MEMBER_COLOR = &"plugin/syntax_plus/member/inner_class_member_color"
