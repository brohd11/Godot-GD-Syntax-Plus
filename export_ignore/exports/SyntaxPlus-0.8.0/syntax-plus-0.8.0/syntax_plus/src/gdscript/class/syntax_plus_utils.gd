...
const UEdScriptEditor = preload("res://addons/syntax_plus/src/remote/script_editor.gd")
const UClassDetail = preload("res://addons/syntax_plus/src/remote/u_class_detail.gd")
### Plugin Exporter Global Classes
